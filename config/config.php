 ...
 * BASIC
 */
$config['site_title'] = "We've Traveled So Far...";              // Site title
...
/*
 * TIMEZONE force config
 */
date_default_timezone_set('US/Eastern');              // Timezone may be reqired by your php install
